<template>
  <div>
    <div>
      <el-input v-model="jl.name" placeholder="添加职称名称" prefix-icon="el-icon-plus"
    ...
    <el-dialog
      ...
      <table>
        <tr>
          ...
          <td>
            <el-input style="margin-left: 8px" v-model="updateJl.name" size="small"></el-input>
          </td>
        </tr>
        <tr>
          <td>
